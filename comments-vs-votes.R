...
p.w.c <- sqlQuery(dbhandle, 'SELECT Created, url, total_vote_weight, category, net_votes, children, total_payout_value, total_pending_payout_value, author, reputation FROM Comments WHERE depth=0 AND Created BETWEEN \'2017-2-12\' AND \'2017-2-19\' AND net_votes > 0 ORDER BY ID DESC')
